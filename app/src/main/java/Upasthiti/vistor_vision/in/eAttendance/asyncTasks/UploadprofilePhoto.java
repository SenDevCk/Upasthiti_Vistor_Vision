...
public class UploadprofilePhoto extends AsyncTask<String, Void, String> {

    Activity activity;
    private ProgressDialog dialog1;
    private AlertDialog alertDialog;
    ArrayList<ViewEmpProfile> viewEmpProfiles = new ArrayList<>();
    public UploadprofilePhoto(Activity activity){
    ...
    protected String doInBackground(String... strings) {
        ...
        if (Utiilties.isOnline(activity)) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                result = WebServiceHelper.UploadPhotoPath(strings);
            }else{
    ...
    protected void onPostExecute(String res) {
        ...
        if (res==null){
            ...
            if (res.contains("SUCCESS")){
                ...
                alertDialog.setMessage("Successfully Updated Your Profile Pic ! \n"+res);
                alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                ...
                alertDialog.setMessage("Unsuccessfully Update Your Profile Pic !\n"+res);
                alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                    }
