...
public class CheckInAttendance extends AsyncTask<String, Void, String> {

    Activity activity;
    private ProgressDialog dialog1;
    private AlertDialog alertDialog;
    public CheckInAttendance(Activity activity){
    ...
    protected String doInBackground(String... strings) {
        ...
        if (Utiilties.isOnline(activity)) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                result = WebServiceHelper.MarkAttendance(strings);
            }else{
    ...
    protected void onPostExecute(String res) {
        ...
        if (res==null){
            ...
            if (res.contains("SUCCESS")){
                ...
                alertDialog.setMessage("CheckIn Successful !");
                alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        activity.finish();
