...
public class CheckOutAttendance extends AsyncTask<String, Void, String> {

    Activity activity;
    private ProgressDialog dialog1;
    private AlertDialog alertDialog;
    public CheckOutAttendance(Activity activity){
    ...
    protected String doInBackground(String... strings) {
        ...
        if (Utiilties.isOnline(activity)) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                result = WebServiceHelper.OutAttendance(strings);
            }else{
    ...
    protected void onPostExecute(String res) {
        ...
        if (res==null){
            ...
            if (res.contains("SUCCESS")){
                ...
                alertDialog.setMessage("CheckOut Successful !");
                alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        activity.finish();
                ...
                alertDialog.setMessage("CheckOut Unsuccessful !\n"+res);
                alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                    }
