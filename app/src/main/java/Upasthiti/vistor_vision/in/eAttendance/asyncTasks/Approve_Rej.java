...
public class Approve_Rej extends AsyncTask<String, Void, String> {

    Activity activity;
    private ProgressDialog dialog1;
    private AlertDialog alertDialog;
    public Approve_Rej(Activity activity){
    ...
    protected String doInBackground(String... strings) {
        ...
        if (Utiilties.isOnline(activity)) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                result = WebServiceHelper.ApproveRejWork(strings);
            }else{
    ...
    protected void onPostExecute(String res) {
        ...
        if (res==null){
            ...
            if (res.contains("1")){
                ...
                alertDialog.setMessage("Approve / Reject Successful !\n"+res);
                alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        activity.finish();
                ...
                alertDialog.setMessage("Approve / Reject  Unsuccessful !\n"+res);
                alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                    }
