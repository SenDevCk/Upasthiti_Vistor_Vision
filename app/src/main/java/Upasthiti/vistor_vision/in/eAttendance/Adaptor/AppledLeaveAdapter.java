...
public class AppledLeaveAdapter extends BaseAdapter {
    ...
    private ArrayList<AppliedLeaveData> mEntries = new ArrayList<AppliedLeaveData>();

    public AppledLeaveAdapter(Context context, ArrayList<AppliedLeaveData> mEntries) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Apply_Date.setText(mEntries.get(position).getEmpName());
        From_Date.setText(mEntries.get(position).getBuniyadCenter());
        To_Date.setText(mEntries.get(position).getAppRemarks());
    ...
    public void upDateEntries(ArrayList<AppliedLeaveData> entries) {
        mEntries = entries;
